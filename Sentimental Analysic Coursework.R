...
#Filter the Restaurant from the main dataset and create 30 separate datasets
...
#Create text vectors for the 30 Hotel restaurants selected by using this code
...
#Convert all text to lower case for the 30 Hotel restaurants selected by using this code
...
#Remove links from the reviews for the 30 Hotel restaurants selected by using this code
...
#Remove punctuation from the reviews for the 30 Hotel restaurants selected by using his code
...
#Remove digits from the reviews for the 30 Hotel restaurants selected by using his code
...
#Inspect the vectors after cleaning the 30 selected hotel restaurant then i select 
#any 5 at random to inspect
